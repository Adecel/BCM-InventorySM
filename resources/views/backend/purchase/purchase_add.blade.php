    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Page d'ajoute des achats </h4>
                        <br><br>
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('purchase.store') }}">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-info" id="storeButton">Faire un achat</button>
...
<script type="text/javascript">
    $(document).ready(function(){
        $(document).on("click",".addeventmore", function(){
            ...
            if(date == ''){
                $.notify("La date est obligatoire" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
                  if(purchase_no == ''){
                $.notify("Le numéro d'achat est requis" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
                  if(supplier_id == ''){
                $.notify("Le fournisseur est obligatoire" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
                  if(category_id == ''){
                $.notify("La catégorie est obligatoire" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
                  if(product_id == ''){
                $.notify("Le produit est obligatoire" ,  {globalPosition: 'top right', className:'error' });
                return false;
                 }
