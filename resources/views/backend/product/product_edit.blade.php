    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">la page des modifications du produit </h4><br><br>
                        <form method="post" action="{{ route('product.update') }}" id="myForm" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="supplier_id" class="form-select" aria-label="Default select example">
                                        <option selected="">sélectionne</option>
                            ...
                            <!-- end row -->
                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Mettre à jour le Produit">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->
