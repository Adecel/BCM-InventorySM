                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Nom et Prénom du client</label>
                                ...
                                <!-- end row -->
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">téléphone du client</label>
                                    <div class="form-group col-sm-10">
