                            ...
                            <form method="post" action="{{ route('supplier.update') }}" id="myForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="name" value="{{ $supplier->name }}" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="mobile_no" value="{{ $supplier->mobile_no }}" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="email" value="{{ $supplier->email }}" type="email">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="address" value="{{ $supplier->address }}" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
